-- Create a test employee account for UI testing.
-- Login: arjun.test@nasheedio.com / Test1234!
-- Role : team_member (tech department)
-- Linked to: Creator Analytics Dashboard v2 project
