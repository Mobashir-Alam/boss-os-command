...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.connector_data_github_daily TO authenticated;
GRANT ALL ON public.connector_data_github_daily TO service_role;
