-- Slack analytics persistence layer (5 tables)
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.connector_slack_workspace TO authenticated;
GRANT ALL ON public.connector_slack_workspace TO service_role;
...
CREATE INDEX IF NOT EXISTS slack_channels_startup_idx ON public.connector_data_slack_channels (startup_id);
GRANT SELECT, INSERT, UPDATE, DELETE ON public.connector_data_slack_channels TO authenticated;
GRANT ALL ON public.connector_data_slack_channels TO service_role;
...
CREATE INDEX IF NOT EXISTS slack_channel_stats_startup_date_idx ON public.connector_data_slack_channel_stats (startup_id, stat_date DESC);
GRANT SELECT, INSERT, UPDATE, DELETE ON public.connector_data_slack_channel_stats TO authenticated;
GRANT ALL ON public.connector_data_slack_channel_stats TO service_role;
...
CREATE INDEX IF NOT EXISTS slack_users_startup_idx ON public.connector_data_slack_users (startup_id);
GRANT SELECT, INSERT, UPDATE, DELETE ON public.connector_data_slack_users TO authenticated;
GRANT ALL ON public.connector_data_slack_users TO service_role;
...
CREATE INDEX IF NOT EXISTS slack_user_stats_startup_date_idx ON public.connector_data_slack_user_stats (startup_id, stat_date DESC);
GRANT SELECT, INSERT, UPDATE, DELETE ON public.connector_data_slack_user_stats TO authenticated;
GRANT ALL ON public.connector_data_slack_user_stats TO service_role;
